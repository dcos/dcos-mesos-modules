...
// NOTE: This file is a direct copy of Mesos' `src/test/main.cpp` and
// it needs to be kept in sync when it comes to fixes on the original.
// We chose to not do an automated copy here as that might cause
// confusing problems and also the original is rather stable.
// TODO(tillt): Automate this.
