...
Metrics::Metrics()
  : registering("overlay/slave/registering"),
    ...
    agent_registered_acknowledgements_received(
      "overlay/slave/internal/agent_registered_acknowledgements_received"),
    agent_registered_acknowledgements_dropped(
      "overlay/slave/internal/agent_registered_acknowledgements_dropped")
{
  ...
  process::metrics::add(agent_registered_acknowledgements_received);
  process::metrics::add(agent_registered_acknowledgements_dropped);
}
...
Metrics::~Metrics()
{
  ...
  process::metrics::remove(agent_registered_acknowledgements_received);
  process::metrics::remove(agent_registered_acknowledgements_dropped);
}
